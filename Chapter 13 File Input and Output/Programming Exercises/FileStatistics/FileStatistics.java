...
public class FileStatistics {
    public static void main(String[] args) {
        try {
            Path path = Paths.get("enter path here\\IdeaProjects\\Java-Programming-8th-Edition\\Chapter 13 File Input and Output\\Programming Exercises\\FileStatistics\\file.txt");
